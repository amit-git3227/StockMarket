    ...
    $(".scratch-section").toggleClass("active");
});
...
(function() {
  ...
  image.src = 'static/images/banner/scratch.jpg'
  image.onload = function() {
    ctx.drawImage(image, 0, 0);
    // Show the form when Image is loaded.
    document.querySelectorAll('.result-part')[0].style.visibility = 'visible';

  };
   brush.src = 'static/images/banner/scratch.jpg'
  ...
  function handlePercentage(filledInPixels) {
    ...
    if (filledInPixels > 75) {
      canvas.parentNode.removeChild(canvas);
       $(".congrats-messege").css({'visibility': '',
    'visible': ''});
       $(".coins-messege").css({'visibility': '',
    'visible': ''});
